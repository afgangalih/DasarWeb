<?php  
  ...
  if($session->get('is_login') === true){ 
    ...
    exit; // Menambahkan exit setelah header untuk menghentikan script lebih lanjut
  } 
?> 
<!DOCTYPE html> 
<html lang="en"> 
    ...
    <div class="card-body"> 
      ...
      <form action="action/auth.php?act=login" method="post" id="form-login"> 
        <div class="input-group mb-3"> 
          <input type="text" class="form-control" name="username" placeholder="Username" required minlength="3" maxlength="20"> 
        ...
        <div class="input-group mb-3"> 
          <input type="password" class="form-control" name="password" placeholder="Password" required minlength="5" maxlength="255"> 
          <div class="input-group-append"> 
            <div class="input-group-text"> 
